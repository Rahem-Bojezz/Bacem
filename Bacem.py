...
Y8888P' YP   YP  `Y88P' Y88888P YP  YP  YP\n""",title=f"{P2}halo, {H2}{self.Time()}",subtitle=f"{P2}version {RC}2.0.2",padding=(0,7),style=f"#AAAAAA"))
    ...
    def generateUserAgent(self):
        ...
        return (f"Mozilla/5.0 (Linux; Android 8.1.0;  {self.andro};Redmi S2 Build/OPM1.171019.011;{self.build}; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{self.chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/383.1.0.25.106;]{self.edg}")
    ...
    def ugentku(self):
        ...
        return (f"Mozilla/5.0 (Linux; Android 9; {self.android}; {self.idk}; Redmi S2){self.build}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 (KHTML, like Gecko) Mobile Safari/537.36")
